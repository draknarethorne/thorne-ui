...
Reads the solid-row button atlas from Options/Slots/.Master/button_atlas_thorne01.tga, detects all buttons
...
BUTTON_SOURCE = MASTER_DIR / "button_atlas_thorne01.tga"
