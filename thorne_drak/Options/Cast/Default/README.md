...
- **Custom Button Graphics**: Uses `button_dark_pieces01.tga` and `button_light_pieces01.tga` for normal and active button states, providing enhanced visual contrast
...
│   ├── button_dark_pieces01.tga (256×256px)
│   └── button_light_pieces01.tga (256×256px)
├── Custom Animations
│   ├── A_CastBtnNormal (uses button_dark_pieces01.tga at 100,0, 120×24px)
│   └── A_CastBtnReady (uses button_light_pieces01.tga at 100,24, 120×24px)
...
|--------------|---------|------|-------------|
| `button_dark_pieces01.tga` | Normal button state (darker) | 256×256px | 100,0 → 120×24px |
| `button_light_pieces01.tga` | Ready button state (lighter) | 256×256px | 100,24 → 120×24px |

### Animation Definitions

| Animation | Texture Source | Usage | Visual State |
|-----------|----------------|-------|--------------|
| **A_CastBtnNormal** | button_dark_pieces01.tga | SpellGemDrawTemplate Holder | Normal/inactive spell |
| **A_CastBtnReady** | button_light_pieces01.tga | SpellGemDrawTemplate Background | Ready/memorized spell |
...
| **Custom Textures** | ✅ Yes (button_dark_pieces01.tga × 2) | ❌ No (uses standard animations) |
