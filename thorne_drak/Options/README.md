...
1. Navigate to the desired category folder (e.g., `Options/Gauges/Bubbles/`)
2. Copy the XML file(s) to `thorne_drak/` root
3. Reload UI in-game (`/loadskin thorne_drak 1`)
...
- **Bars** — Flat bar style
- **Basic** — Simple fills
- **Bubbles** — Bubble segmented gauges
- **Grid** — Grid overlay style
...
- **Thorne Classic** — Original Thorne style
- **Thorne Inventory** — With inventory access
...
- **Infiniti** — Infiniti icon set
- **Steamworks** — Steampunk themed
- **Thorne** — Thorne curated set *(default)*
...
- **Thorne 14x1 Stacked** — Vertical single column
- **Thorne 1x14 Stacked** — Horizontal single row  
- **Thorne 2x7 Stacked** — Two columns
...
| Prefix | Meaning |
|--------|---------|
| **Standard** | EQ client baseline (unmodified) |
| **Thorne** | Thorne UI default configuration |
| **Thorne [Modifier]** | Variant of Thorne default |
| **[Other Name]** | Community or specialized style |
...
All Thorne variants share a visual language:
- **Gauge heights**: 15px standard, 24px large
- **Text colors**: White primary, yellow highlights
- **HP fill**: Red (200,50,50)
- **Mana fill**: Blue (80,80,200)
- **Pet fill**: Purple (200,80,200)
- **Borders**: Dark theme with subtle gradients

---

## 🎨 Creating New Variants

1. Copy an existing variant folder as a template
2. Modify XML files for your configuration
3. Create a `README.md` documenting changes
4. Test in-game with `/loadskin thorne_drak 1`

See [Actions/README.md](Actions/README.md) for a well-documented template example.
