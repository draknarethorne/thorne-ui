...
SOURCE_BUTTONS_FILE = ROOT / "thorne_drak" / "button_atlas_thorne01.tga"

# Source file crop positions (where icon and button are located in source files)
ICON_X, ICON_Y = 2, 2
# Button positions in button_atlas_thorne01.tga (255x255 atlas with 6 rows, 2px button gap, 2px row gap)
...
def main() -> None:
    ...
    print(f"Button type: {button_label} (from button_atlas_thorne01.tga row {button_row})")
