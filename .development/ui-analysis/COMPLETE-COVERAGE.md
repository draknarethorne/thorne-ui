...
- `button_pieces01.tga`, `button_pieces01_light.tga` - Button texture variants
- `gauge_pieces01.tga`, `gauge_pieces01_tall.tga`, `gauge_pieces02.tga`, `gauge_pieces03.tga`, `gauge_pieces04.tga`, `gauge_pieces05.tga` - Gauge variants (6 files)
...
**Unique texture features:**
- **Button pieces**: button_pieces01.tga, button_pieces01_light.tga (2 button texture variants)
- **Gauge pieces**: gauge_pieces01.tga, gauge_pieces01_tall.tga, gauge_pieces02.tga, gauge_pieces03.tga, gauge_pieces04.tga, gauge_pieces05.tga (6 gauge variants including tall version)
- **Special UI elements**:
  - ovalbar.tga (oval-shaped bar texture)
  - stat_icon_pieces01.tga (stat icon texture sheet for v0.7.0+)
