...
- **Custom Button Graphics**: Uses `buttons_dark_thorne01.tga` and `buttons_light_thorne01.tga` for normal and active button states, providing enhanced visual contrast
...
│   ├── buttons_dark_thorne01.tga (256×256px)
│   └── buttons_light_thorne01.tga (256×256px)
├── Custom Animations
│   ├── A_CastBtnNormal (uses buttons_dark_thorne01.tga at 100,0, 120×24px)
│   └── A_CastBtnReady (uses buttons_light_thorne01.tga at 100,24, 120×24px)
...
|--------------|---------|------|-------------|
| `buttons_dark_thorne01.tga` | Normal button state (darker) | 256×256px | 100,0 → 120×24px |
| `buttons_light_thorne01.tga` | Ready button state (lighter) | 256×256px | 100,24 → 120×24px |

### Animation Definitions

| Animation | Texture Source | Usage | Visual State |
|-----------|----------------|-------|--------------|
| **A_CastBtnNormal** | buttons_dark_thorne01.tga | SpellGemDrawTemplate Holder | Normal/inactive spell |
| **A_CastBtnReady** | buttons_light_thorne01.tga | SpellGemDrawTemplate Background | Ready/memorized spell |
...
| **Custom Textures** | ✅ Yes (buttons_dark_thorne01.tga × 2) | ❌ No (uses standard animations) |
...
2. Ensure `buttons_dark_thorne01.tga` and `buttons_light_thorne01.tga` exist in `thorne_drak/`
