...
vim README.md
# Add: **v0.4.0** (February 15, 2026) with changes
...
1. ✅ Extract version from tag (e.g., `v0.4.0` → `0.4.0`)
2. ✅ Generate changelog from commits since last release
3. ✅ **Package thorne_drak as ZIP:** `thorne_drak-v0.4.0.zip` (~2.4 MB)
4. ✅ **Create complete package:** `thorne-ui-v0.4.0.zip` (thorne_drak + docs, ~2.8 MB)
...
- **v0.4.0** - Minor release (new features, new windows)
...
git tag 0.4.0   # ✗ Won't trigger workflow
```
